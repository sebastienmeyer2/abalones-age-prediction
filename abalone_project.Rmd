...
log_cols <- c(
    "adulthood", "log_length", "log_diameter", "height", "height2", "log_whole_weight",
...
```{r}
lm_log_multi <- lm(
    log_rings ~ log_diameter + log_length + height + height2 + log_shucked_weight +
    log_viscera_weight + log_whole_weight + log_shell_weight + adulthood,
    data = abalone_train
)
```
